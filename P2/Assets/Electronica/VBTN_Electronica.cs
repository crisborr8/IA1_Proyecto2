...
public class VBTN_Electronica : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        obj_texto.text = "Ing. Electrónica";
        HideAllMedia();
    }
    ...
    {
        HideAllMedia();
        obj_texto.text = "Ing. Electrónica\nClase: Teoría electromagnética\nClase sobre el estudio de las interacciones entre la electricidad y el magnetismo en la ingeniería electrónica.";
    ...
    {
        HideAllMedia();
        obj_texto.text = "Ing. Electrónica\nClase: Electrónica\nClase que abarca los fundamentos teóricos y prácticos de los circuitos electrónicos y sus aplicaciones en la ingeniería.";
    ...
    {
        HideAllMedia();
        obj_texto.text = "Ing. Electrónica\nClase: Circuitos elécticos\nClase centrada en el análisis y diseño de circuitos eléctricos, abordando leyes, teoremas y componentes básicos de la ingeniería electrónica.";
    ...
    {
        HideAllMedia();
        obj_texto.text = "Ing. Electrónica\nClase: Robótica\nClase sobre diseño, construcción y programación de robots para aplicaciones prácticas en ingeniería electrónica.";
    ...
    {
        HideAllMedia();
        obj_texto.text = "Ing. Electrónica\nClase: Telecomunicaciones y redes locales\nClase que explora los principios y tecnologías de las telecomunicaciones, así como el diseño y gestión de redes locales de comunicación.";
